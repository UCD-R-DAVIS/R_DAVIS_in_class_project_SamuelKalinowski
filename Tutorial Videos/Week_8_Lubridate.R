...
#The string must be of the form YYYY-MM-DD
...
#to fix any error, need to specify the format to look like so:
...
#whn working with time, POSIXct is the best class to work with
...
#posixct assumes you collected your data in the timezone your computer is set to. To change this, set the timezone to "GMT"
...
lubridate::ymd_hm("2016-01-01 12:00", tz = "America/LosAngles")
...
mloa2 <- read_csv("https://raw.githubusercontent.com/UCD-R-DAVIS/R-DAVIS/main/data/mauna_loa_met_2001_minute.csv", col_types = "cccccccddddddddd")
