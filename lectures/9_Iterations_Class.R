...
## column of data
#first way with brackets is baseR, second is the tidyverse way
...
#for loops stores values in the environment that we put into them
...
# we want to do this for every row in cars data, we could hard code but more robust to soft code
